...
calc_bruteforce_cardinality = function(password) {
  var c, chr, digits, lower, ord, symbols, unicode, upper, _i, _len, _ref, _ref1;
  _ref = [false, false, false, false, false], lower = _ref[0], upper = _ref[1], digits = _ref[2], symbols = _ref[3], unicode = _ref[4];
